...
<body>
    ...
    <div class="container mt-5">
        <div class="alert alert-success" role="alert">
            ...
            <p>Thank you for your purchase from SSF Food Ordering. Please let us know if we can do anything else for
                you!</p>
            <hr>
            <p class="mb-0 fw-bold">Hope You Liked Our System!!!!!</p>
        </div>
    </div>
